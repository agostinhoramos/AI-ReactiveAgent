...
var Thread = {
    ...
    next: function (callback) {
        ...
        if (Thread.agent.length > 0) { pos = Thread.agent; }
                    ...
                    if (MOVE.LAST_DIR > 0) {
                        ...
                        setTimeout(() => {
                            if (GEO.LIMIT.WHERE_GOLD !== null) {
                                ...
                                output.result.write('<span class="text-success" >O agente termina aqui, por ter '
                                + 'conseguido alcançar o objetivo, encontrar o ouro.</span>');
                                GEO.DRAW(e);
                            } else {
                                output.cell(e, ["NIL"]);
                                output.result.write('<span class="text-secondary" >O agente termina sem encontrar o Ouro.<span>');
                                output.step_role(5);
                                output.sensors4([
                                    [0, 0, 0, 0],
                                    [e, 5]
